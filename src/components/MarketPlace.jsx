  ...
  return (
    <Section>
      <div className="title">
        ...
        <p>
        An NFT marketplace is essentially an online trading platform designed for the exchange of NFTs. Built on blockchain technology, these marketplaces ensure the authenticity and ownership of digital assets through secure transactions. Users can browse, buy, and sell NFTs either at fixed prices or through auctions.
        </p>
      </div>
        ...
        {marketPlaceData.map(({ image, name }) => {
          return (
            <div className="marketplace">
              ...
              <h6 className="username">@KennethDaniels</h6>
